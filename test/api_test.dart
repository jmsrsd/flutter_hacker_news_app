...
import 'package:flutter_hacker_news_app/api/item/item.api.response.type.dart';
      ...
      ['Item']: {
        ['GET']: {
          ['Poll', 'Part']: () async {
            ...
            expect(time, equals(1207886576));
            expect(type, equals(ItemResponseType.pollopt));
          },
          ['Poll']: () async {
            ...
            expect(kids.runtimeType, equals(EqualUnmodifiableListView<int>));
            expect(parts.runtimeType, equals(EqualUnmodifiableListView<int>));
            expect(score.runtimeType, equals(int));
            expect(text, equals(null));
            expect(time, equals(1204403652));
            expect(
              title,
              equals(
            ...
            expect(type, equals(ItemResponseType.poll));
          },
          ['Job']: () async {
            ...
            expect(time, equals(1210981217));
            expect(
              title,
              equals("Justin.tv is looking for a Lead Flash Engineer!"),
            );
            expect(type, equals(ItemResponseType.job));
            expect(url, equals(""));
          },
          ['Ask']: () async {
            ...
            expect(time, equals(1203647620));
            expect(title, equals("Ask HN: The Arc Effect"));
            expect(type, equals(ItemResponseType.story));
          },
          ['Comment']: () async {
            ...
            expect(
              kids.runtimeType,
              equals(EqualUnmodifiableListView<int>),
            );
            ...
            expect(time, equals(1314211127));
            expect(type, equals(ItemResponseType.comment));
          },
          ['Story']: () async {
